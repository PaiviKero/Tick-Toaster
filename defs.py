...
CONTROL_WINDOW_WIDTH: Final[int] = 350
CONTROL_WINDOW_HEIGHT: Final[int] = 250
CONTROL_WINDOW_START_X: Final[int] = MAIN_WINDOW_START_X+MAIN_WINDOW_WIDTH+20
CONTROL_WINDOW_START_Y: Final[int] = MAIN_WINDOW_START_Y+MAIN_WINDOW_HEIGHT-CONTROL_WINDOW_HEIGHT

CAMERA_IMAGE_SCALING_PERCENTAGE = 0.60
